...
export const SignUpForm: React.FC<SignUpFormProps> = ({
  ...
  const { params } = useRoute<RouteProp<AuthNavigationParamList, "SIGN_UP">>();
  ...
  const onFile = (file: string, upload: string) => {
        ...
        <View style={tailwind("flex-1")}>
          <View style={[tailwind("flex items-center justify-center")]}>
            <TouchableOpacity
              ...
              style={[
                tailwind(
                  "flex-row items-center justify-center bg-gray-700 rounded-full"
                ),
            ...
            >
              {values?.profile ? (
                ...
                <>
                  <Image
                    source={require("../../../../assets/Images/ion_camera-sharp.png")}
                    resizeMode="contain"
                  />
                  <View
                    style={tailwind(
                      "absolute right-5 bottom-7 bg-white p-1 rounded-full"
                    )}
                  >
                    <Image
          ...
          <View style={{ gap: 15, ...tailwind("pt-10 flex") }}>
            ...
            <ConsentCheckbox
              ...
              title={`Gooday can send me marketing emails for future sales and promotions`}
            />
          </View>
        </View>
